...
pop_06['STATE'] = pop_06['STATE'].apply(lambda x: state_fix(x))
pop_06['COUNTY'] = pop_06['COUNTY'].apply(lambda x: county_fix(x))
pop_06['state_code'] = pop_06['STATE'] + pop_06['COUNTY']
pop_06['county_code'] = pop_06['state_code'].apply(lambda x: int(x))
...
pop_06_g.reset_index(inplace=1)
pop_06_g.to_csv('pop_06_output.csv')
