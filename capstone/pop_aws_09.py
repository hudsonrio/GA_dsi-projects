...
pop_09['STATE'] = pop_09['STATE'].apply(lambda x: state_fix(x))
pop_09['COUNTY'] = pop_09['COUNTY'].apply(lambda x: county_fix(x))
pop_09['state_code'] = pop_09['STATE'] + pop_09['COUNTY']
pop_09['county_code'] = pop_09['state_code'].apply(lambda x: int(x))
...
pop_09_g.reset_index(inplace=1)
pop_09_g.to_csv('pop_09_output.csv')
