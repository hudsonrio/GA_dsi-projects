...
pop_03['STATE'] = pop_03['STATE'].apply(lambda x: state_fix(x))
pop_03['COUNTY'] = pop_03['COUNTY'].apply(lambda x: county_fix(x))
pop_03['state_code'] = pop_03['STATE'] + pop_03['COUNTY']
pop_03['county_code'] = pop_03['state_code'].apply(lambda x: int(x))
...
pop_03_g.reset_index(inplace=1)
pop_03_g.to_csv('pop_03_output.csv')
