...
pop_04['STATE'] = pop_04['STATE'].apply(lambda x: state_fix(x))
pop_04['COUNTY'] = pop_04['COUNTY'].apply(lambda x: county_fix(x))
pop_04['state_code'] = pop_04['STATE'] + pop_04['COUNTY']
pop_04['county_code'] = pop_04['state_code'].apply(lambda x: int(x))
...
pop_04_g.reset_index(inplace=1)
pop_04_g.to_csv('pop_04_output.csv')
