...
pop_07['STATE'] = pop_07['STATE'].apply(lambda x: state_fix(x))
pop_07['COUNTY'] = pop_07['COUNTY'].apply(lambda x: county_fix(x))
pop_07['state_code'] = pop_07['STATE'] + pop_07['COUNTY']
pop_07['county_code'] = pop_07['state_code'].apply(lambda x: int(x))
...
pop_07_g.reset_index(inplace=1)
pop_07_g.to_csv('pop_07_output.csv')
