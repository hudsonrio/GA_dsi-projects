...
pop_05['STATE'] = pop_05['STATE'].apply(lambda x: state_fix(x))
pop_05['COUNTY'] = pop_05['COUNTY'].apply(lambda x: county_fix(x))
pop_05['state_code'] = pop_05['STATE'] + pop_05['COUNTY']
pop_05['county_code'] = pop_05['state_code'].apply(lambda x: int(x))
...
pop_05_g.reset_index(inplace=1)
pop_05_g.to_csv('pop_05_output.csv')
