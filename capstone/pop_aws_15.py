...
pop_15['STATE'] = pop_15['STATE'].apply(lambda x: state_fix(x))
pop_15['COUNTY'] = pop_15['COUNTY'].apply(lambda x: county_fix(x))
pop_15['state_code'] = pop_15['STATE'] + pop_15['COUNTY']
pop_15['county_code'] = pop_15['state_code'].apply(lambda x: int(x))
